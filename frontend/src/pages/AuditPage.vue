...
const audit = useQuery({ queryKey: ["audit", cursor, query, actionPrefix, category, resourceType, resultFilter], queryFn: () => apiRequest<AuditPage>(appendQuery("/audit", { limit: 25, cursor: cursor.value, query: query.value, action_prefix: actionPrefix.value, category: category.value, resource_type: resourceType.value, result: resultFilter.value })), staleTime: 30_000 });
...
function clearFilters(): void { query.value = ""; actionPrefix.value = ""; category.value = ""; resourceType.value = ""; resultFilter.value = ""; reset(); }
