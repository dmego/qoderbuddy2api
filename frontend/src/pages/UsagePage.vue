...
type Summary = { request_count: number; input_tokens: number; output_tokens: number; success_count: number; error_count: number; token_event_count: number; missing_token_count: number; latency_avg_ms?: number | null; latency_p95_ms?: number | null; ttft_avg_ms?: number | null; ttft_p95_ms?: number | null; observed_at?: string; status?: string };
