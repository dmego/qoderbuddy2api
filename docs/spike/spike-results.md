...
| --- | --- | --- |
| workbuddy_api | `~/vibeCoding/workbuddy_api` | local reference commit `d5de25a` |
| qoderwork-account-switcher | `~/vibeCoding/qoderwork-account-switcher` | local reference commit `022c1d4` / v1.1.0 |
